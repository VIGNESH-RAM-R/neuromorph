# NEUROMORPH Master Product & Morphy Experience Prompt (v1.0)

Saved verbatim on request, to apply later -- specifically during the Morphy
integration pass, after the dashboard and login are fully polished, and
before backend/real-data work begins. Do not build against this until
explicitly told to.
